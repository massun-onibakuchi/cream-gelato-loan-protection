...
export const constants = {
    [ChainId.Localhost]: [
        { name: 'USDCoin', symbol: 'USDC', decimals: 6, address: CUSDC_ADDRESS, underlyingAddress: USDC_ADDRESS },
        { name: 'MockToken', symbol: 'MOCK', decimals: 18, address: CTOKEN_ADDRESS, underlyingAddress: MOCK_TOKEN_ADDRESS },
    ]
}
